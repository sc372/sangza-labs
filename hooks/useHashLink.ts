...
const isHeadingElement = (a: HeadingElement) => headingElementList.some(aa => a === aa);
const getPrefix = (a: string) => [...Array(parseInt(a) * 3)].reduce((aa, bb) => aa + "\u00A0", "")
const filteredHeadingElement = (a: Element) => isHeadingElement(a.tagName as HeadingElement)
const getHashLinkElement = (a: Element) => [getPrefix(a.tagName.split("")[1]), a.tagName, a.innerHTML]
